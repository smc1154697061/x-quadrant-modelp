...
from app.controllers.organization_controller import OrganizationListResource, OrganizationDetailResource, OrganizationMemberResource, UserSearchResource
...
api.add_resource(OrganizationMemberResource, '/llm/organizations/<int:org_id>/members', endpoint='organization_members')
api.add_resource(OrganizationMemberResource, '/llm/organizations/<int:org_id>/members/<int:user_id>', endpoint='organization_member')
api.add_resource(UserSearchResource, '/llm/users/search', endpoint='user_search')
